function [Mribnum] = computeRibMass(xsnum,hnum,znum,xinum,xfnum,cnum,a_slotnum,a_Alnum,rhonum,x1num,x2num,xAl1num,xAl2num)
...
%     T = h*int(2*int(0.5*rho*diff(w,t)^2,y,0,yt),x,xi,xAl1)...
